 ...
 * @param n
 */
export function randomNIntNotRepeat(low, high, n) {
    const nums = {};
    while (true) {
 ...
 * @param v
 */
export function multiply(data, v) {
    const res = [];
    if (typeof v === 'number') {
 ...
 * @param nDif
 */
export function macd(data, nShort, nLong, nDif) {
 ...
 * @param high
 */
export function normalize(data, low, high) {
 ...
 * @param price
 */
export function brokerage(exchangeType, amount, price) {
 ...
 * @return {number}
 */
export function dotMultiply(a1, a2) {
    let res = 0;
 ...
 * @return {number}
 */
export function covariance(a1, a2) {
    if (a1.length !== a2.length)
 ...
 * @return {number}
 */
export function correlation(a1, a2) {
    const std1 = std(a1);
    const std2 = std(a2);
    if (std1 > 0 && std2 > 0) {
 ...
 * @return {number}
 */
export function r2(label, predictLabel) {
 ...
 * @return {boolean}
 */
export const isCloseable = (a, b, tolerance) => {
    if (!tolerance)
        tolerance = 0.01;
 ...
 * @return {number[]}
 */
export const toBNumber = (num, bitLen) => {
    const bNumArray = [];
 ...
 * @return {number[]}
 */
export const convertColorToHexNumberArray = (num) => {
    const res = [];
    let div = num;
    for (;;) {
 ...
 * @return {string[]}
 */
export const convertColorToHexCharArray = (num) => {
    const charMap = {
        0: '0',
        1: '1',
        2: '2',
 ...
 * @return {number}
 */
export const parseHexColorToNumber = (num) => {
