 ...
 * @return {Promise<T[]>}
 */
const runBatch = (batch, runners) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const getAvailableRunners = (runners, num, timeout) => __awaiter(void 0, void 0, void 0, function* () {
